...
parameters_dict = {
    ...
    'learning_rate': {
        'values': [0.0001, 0.0002, 0.0004, 0.0007, 0.0008, 0.0009, 0.001, 0.0011, 0.0012]
    },
    'smooth_fac': {
        'values': [0.6, 0.7, 0.75, 0.8]
    },
    'hid_dim': {
        'value': 450 
    },
...
sweep_id = '7opl2gam'
wandb.agent(sweep_id, run_exp, project="IterativeMethods",count=100)
