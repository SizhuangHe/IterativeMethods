...
# In this file, we explore the performances of 2/3-layer normal GCNs and 2/3-iteration iterative GCNs on the Cora dataset. 
# The train/validation/test split of the data is exactly the same with that in the GCN paper.
